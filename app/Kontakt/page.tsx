...
const page = () => {
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-4">
              <span className="bg-[#0D3F53] p-4 rounded-full"><a href="https://www.google.com/maps?q=59.8586,17.6389" target="_blank" rel="noopener noreferrer">📍</a></span>
              <p className="text-lg text-black font-bold">Uppsala, Enköping, Stockholm, karlstads,Västerås   </p>
            </div>
            <div className="flex items-center gap-4">
           
              <span className="bg-[#0D3F53] p-4 rounded-full"> <a href="mailto:info@viloserdet.se">✉️</a></span>
  ...
  <span className="bg-[#0D3F53] p-4 rounded-full cursor-pointer"> <a href="tel:0722677774">📞</a></span>
          ...
          <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg shadow-lg text-black">
            ...
            <div className="mb-6">
              <label className="block text-lg font-semibold text-[#0D3F53] mb-2">Nummer</label>
              <input
                type="tel"
                name="number"
