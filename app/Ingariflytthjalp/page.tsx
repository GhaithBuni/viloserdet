  ...
  return (
    ...
    <div className="bg-white text-gray-800">
      <div className="px-4 py-10 md:px-8 lg:px-16 lg:py-20 max-w-screen-xl mx-auto space-y-10 mt-20">
        <h2 className="text-3xl md:text-4xl font-bold text-[#0D3F53]">Flytthjälp</h2>

        <p className="text-base md:text-lg">
          Välkommen till <strong>Vilöserdet Flytthjälp</strong>. Vi är ett erfaret flytt- och städföretag som erbjuder omfattande hjälp med säkerhet, miljöfokus och trygghet. Du får prisgaranti, nöjdgaranti och möjlighet att flytta först och betala sen.
        </p>

        <div className="bg-[#FEF4E8] p-4 md:p-6 rounded-md shadow-md space-y-4">
          <h3 className="text-xl md:text-2xl font-semibold text-[#0D3F53]">Ingår i vårt fasta pris</h3>
          <ul className="list-disc pl-5 space-y-1 text-base md:text-lg">
            <li>Pålastning och avlastning av alla ägodelar</li>
            <li>Säker transport upp till 30 km (10 kr/km extra därefter)</li>
        ...
        <div className="space-y-4">
          <h3 className="text-xl md:text-2xl font-semibold text-[#0D3F53]">Extra tjänster</h3>
          <ul className="list-disc pl-5 space-y-1 text-base md:text-lg">
            <li>Packning och uppackning: 250 kr/timme/person</li>
        ...
        <div className="space-y-4">
          <h3 className="text-xl md:text-2xl font-semibold text-[#0D3F53]">Inför flytten</h3>
          <ul className="list-disc pl-5 space-y-1 text-base md:text-lg">
        ...
        <div className="space-y-4">
          <h4 className="text-lg md:text-xl font-medium text-[#0D3F53]">Under packningen</h4>
          <ul className="list-disc pl-5 space-y-1 text-base md:text-lg">
        ...
        <div className="space-y-4">
          <h4 className="text-lg md:text-xl font-medium text-[#0D3F53]">Specifika riktlinjer</h4>
          <ul className="list-disc pl-5 space-y-1 text-base md:text-lg">
            ...
            <li>Tavlor och växter: Packa i bubbelplast/wellpapp. Vi ersätter inte växter</li>
            <li>Vitvaror: Koppla ur och emballera</li>
          </ul>
        </div>

        <div className="space-y-4">
          <h3 className="text-xl md:text-2xl font-semibold text-[#0D3F53]">Av- och ombokning</h3>
          <ul className="list-disc pl-5 space-y-1 text-base md:text-lg">
            ...
            <li>Extra fakturering kan ske vid orimlig bohagsmängd eller felaktiga uppgifter</li>
          </ul>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-base md:text-lg">
            Faktura skickas efter flytten. Priset inkluderar moms och RUT-avdrag. Betalning ska ske inom 10 dagar. Vi hanterar RUT-ansökan till Skatteverket.
          </p>
        </div>
      </div>
