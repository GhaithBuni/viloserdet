...
const validationSchemaClean = yup.object().shape({
  ...
  lägenhetsnycklar: yup.string().required("Lägenhetsnycklar är obligatoriska"),
});

export default validationSchemaClean;
