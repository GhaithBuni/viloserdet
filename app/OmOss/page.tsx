        ...
        <div className="container mx-auto px-6 md:px-12 mt-12 grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mt-4 text-lg text-gray-700">
              ...
              strävar efter att göra varje upplevelse minnesvärd och
            ...
            <div className="mt-6 text-gray-700">
              ...
              <ul className="list-disc list-inside mt-4 space-y-2">
                <li>
                  <strong>Flytthjälp</strong> – Oavsett om du flyttar lokalt
                  eller långväga, ser vi till att din flytt går smidigt och
                  effektivt. Vi hanterar allt från packning och transport till
                  uppackning och möblering.
                </li>
                <li>
                ...
                <li>
                  <strong>Visningsstädning</strong> – Professionell städning
                  inför bostadsvisningar för att skapa det bästa första
                  intrycket.
                </li>
                <li>
                  <strong>Kontorsflytt och städ</strong> – Vi hjälper företag
                  med en smidig kontorsflytt och ser till att arbetsplatsen är
                  ren och trivsam.
                </li>
              </ul>
            </div>
            ...
            <p className="mt-6 text-lg text-gray-700">
              ...
              erfarna flytt- och städproffs utför arbetet noggrant och
              effektivt.
            </p>
            ...
            <p className="mt-2">
              ...
              Samtidigt är flytten en tidspressad process där mycket måste
              klaffa, och många känner sig överväldigade av ansvaret. Att
              kombinera flytt med städning gör det ännu mer krävande, och vi såg
              hur många lägger ner tid och energi på att göra sitt bästa – bara
              för att ändå bli debiterade av hyresvärden för omstädning. Detta
              skapade onödig stress och ekonomiska kostnader.
            </p>
            <p className="mt-2">
              Denna insikt inspirerade till skapandet av VLÖSERDET. Vi ville
              vara lösningen på detta problem och göra flytten till en smidig
            ...
            <p className="mt-2">
              ...
              trygghet i hela processen. Med våra tjänster kan du fokusera på
              ditt nya kapitel i livet medan vi tar hand om det praktiska
            </p>
            ...
            <p className="mt-2">
              ...
              våra kunder. VLÖSERDET är resultatet av en personlig erfarenhet
              som utvecklades till en passion för att göra skillnad. Vi är här
              för att bryta cykeln av onödig stress och osäkerhet.
            </p>
          ...
          <div className="bg-[#FEF4E8] p-8 rounded-lg shadow-md  ">
            ...
            <p className="mt-2 text-lg text-gray-700">
              ...
              förväntningar och göra varje flytt- och städupplevelse så smidig
              som möjligt.
            </p>
            ...
            <p className="mt-2 text-lg text-gray-700">
              Vår personal är vår styrka. Genom att skapa en positiv och
              stöttande arbetsmiljö ser vi till att vårt team trivs och kan
              leverera bästa möjliga service till dig.
            </p>
          </div>
        </div>
