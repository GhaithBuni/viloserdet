...
const tips = [
  {
    ...
    description: "Packa rum för rum och märk alla lådor tydligt. Börja med saker du inte använder dagligen.",
  },
  {
    title: "🛠 Använd rätt packmaterial",
    description: "Använd bubbelplast, flyttlådor och tejp av god kvalitet för att skydda dina ägodelar.",
  },
  {
    title: "✅ Gör en checklista",
    description: "En detaljerad checklista hjälper dig att hålla koll på allt som måste göras inför flytten.",
  },
  {
    title: "📩 Meddela adressändring",
    description: "Glöm inte att meddela myndigheter, banken och försäkringsbolag om din nya adress.",
  },
  {
    title: "🚚 Boka flytthjälp i tid",
    description: "Se till att boka flyttfirma i god tid för att säkerställa tillgänglighet på ditt flyttdatum.",
  }
];
